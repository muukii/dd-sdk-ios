...
class FeatureMessageReceiverTests: XCTestCase {
    ...
    func testNOPReceiver_returnsFalse() throws {
        ...
        XCTAssertFalse(try receiver.receive(message: .baggage(label: .mockAny(), value: "test"), from: core))
    ...
    func testCombinedReceiver_withValidReceiver_returnsTrue() throws {
        ...
        XCTAssertTrue(try receiver.receive(message: .baggage(label: .mockAny(), value: "test"), from: core))
